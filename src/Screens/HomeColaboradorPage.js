  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.body}>
          <TouchableHighlight onPress={() => navigation.navigate('ChangePlan')} underlayColor={null} style={styles.boxHighlight}>
            <View style={styles.box}>
          
                <Text style={styles.boxText}>Mudar</Text>
                <Text style={styles.boxText}>Planos </Text>
         
              <FontAwesome5 name="list-alt" size={120} color="#000" />
            </View>
          </TouchableHighlight>
          ...
          <TouchableHighlight onPress={() => navigation.navigate('ConfigPage')} underlayColor={null} style={styles.boxHighlight}>
            <View style={styles.box}>
              ...
              <FontAwesome name="gear" size={125} color="#000"/>
            </View>
          </TouchableHighlight>
      </View>
    </View>
